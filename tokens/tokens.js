...
const decisions = {
  ...
  bg: {
    base: choices.color.purple[50],
    primaryLightest: choices.color.purple[100],
    primaryLighter: choices.color.purple[200],
    primaryLight: choices.color.purple[300],
    primary: choices.color.purple[600],
    primaryDark: choices.color.purple[700],
    neutralLightest: choices.color.neutral[50],
    neutral: choices.color.neutral[100],
    neutralDark: choices.color.neutral[200],
    neutralDarker: choices.color.neutral[600],
    neutralDarkest: choices.color.neutral[800],
    disabled: choices.color.neutral[200],
    errorLighter: choices.color.red[50],
    errorLight: choices.color.red[100],
    error: choices.color.red[500],
    errorDark: choices.color.red[800],
    successLight: choices.color.green[50],
    success: choices.color.green[500],
    successDark: choices.color.green[700],
    warningLight: choices.color.yellow[50],
    warning: choices.color.yellow[600],
    warningDark: choices.color.yellow[700],
  },
}
