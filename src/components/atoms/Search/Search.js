    ...
    <StyledSearch id={id} htmlFor={id}>
      <span className='search-icon'>
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path fill-rule="evenodd" clip-rule="evenodd" d="M10.3929 10.3929C10.7834 10.0023 11.4166 10.0023 11.8071 10.3929L14.7071 13.2929C15.0976 13.6834 15.0976 14.3166 14.7071 14.7071C14.3166 15.0976 13.6834 15.0976 13.2929 14.7071L10.3929 11.8071C10.0024 11.4166 10.0024 10.7834 10.3929 10.3929Z" fill="#404040"/>
        </svg>
      </span>
