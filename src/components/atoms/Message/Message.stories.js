...
export const SingleIncoming = {
  args: { variant: 'incoming', position: 'single' },
}
export const SingleOutgoing = {
  args: { variant: 'outgoing', position: 'single' },
}

export const FirstIncoming = {
  args: { variant: 'incoming', position: 'first' },
}
export const FirstOutgoing = {
  args: { variant: 'outgoing', position: 'first' },
}

export const MiddleIncoming = {
  args: { variant: 'incoming', position: 'middle' },
}
export const MiddleOutgoing = {
  args: { variant: 'outgoing', position: 'middle' },
}
